        ...
        <div className='container'>
            ...
            <div className='rightPanel'>
                ...
                <div className='monthlyPaymentCounter'>
                    <h1>{loanPeriodValue > 0 ? numberWithSpaces(monthlyPayment.toFixed()) : '41 893'} ₽</h1>
                </div>
                <div className='rightPanelElement'>
                    <p>Кредит</p>
                    <div >
                        <p>{loanPeriodValue > 0 ? numberWithSpaces(estateValue - firstDepositValue) : '500 000'} ₽</p>
                    </div>
                </div>
                <div className='rightPanelElement'>
                    <p>Проценты</p>
                    <div >
                        <p>{loanPeriodValue > 0 ? numberWithSpaces(percents) : '2 712'} ₽</p>
                    </div>
                </div>
                <div className='rightPanelElement'>
                    <p>Проценты+кредит</p>
                    <div >
                        <p>{loanPeriodValue > 0 ? numberWithSpaces(estateValue - firstDepositValue + percents) : '502 712'} ₽</p>
                    </div>
                </div>
                <div className='rightPanelElement'>
                    <p>Необходимый доход</p>
                    <div >
                        <p>{loanPeriodValue > 0 ? numberWithSpaces(minIncome) : '69 835'} ₽</p>
                    </div>
                </div>
